              ...
              {isOwnProfile && (
                <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
                  ...
                  <div className="border-t border-gray-200 pt-3 flex">
                    <button className="flex-1 flex justify-center items-center gap-2 text-gray-600 hover:bg-gray-100 py-2 rounded-md font-semibold text-[15px]">
...
console.log('Done ProfilePage rewrite');
